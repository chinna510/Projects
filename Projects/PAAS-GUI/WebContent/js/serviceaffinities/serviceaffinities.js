...
myserviceaffinities.controller('MainCtrl', function($scope,$http) {
    ...
    $scope.regServiceAffinities = function() {
    	...
    	var res = $http.post('/PAAS-GUI/rest/fetchData/storeServiceAffinities', userData);
    ...
    /*==================POPULATE DATA TO TABLE===================*/
 	 ...
 	 $scope.selectServiceAffinities = function() {
 		 console.log("hiii");
    	var response = $http.get('/PAAS-GUI/rest/fetchData/selectServiceAffinities');
    ...
    $scope.deleteServiceAffinities = function(data) {
     	var response = $http.get('/PAAS-GUI/rest/fetchData/deleteServiceAffinities/'+data);
     	response.success(function(data){
     		$scope.select();
     	});
     	response.error(function(data, status, headers, config) {
