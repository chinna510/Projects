package com.kafka.OldSimpleConsumerAPI;
...
public class SimpleExample {
	static Logger logger = Logger.getLogger(SimpleExample.class);
	...
	private PartitionMetadata findLeader(List<String> a_seedBrokers, int a_port, String a_topic, int a_partition) {
		...
		loop: for (String seed : a_seedBrokers) {
			...
			try {
				...
				logger.info("Error communicating with Broker [" + seed + "] to find Leader for [" + a_topic + ", "
...
}//arguments: 100 pagetest 32 1 2181