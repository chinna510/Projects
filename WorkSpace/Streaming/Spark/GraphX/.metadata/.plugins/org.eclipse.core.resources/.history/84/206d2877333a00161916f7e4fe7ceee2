...
public class DiffApp implements Serializable {

	private static final long serialVersionUID = 1L;
	static Logger log = Logger.getLogger(DiffApp.class);
	...
	public void test() {
		...
		minusList.add(new Tuple2<Object, Integer>(7L, 43));

		minusList.add(new Tuple2<Object, Integer>(3L, 34));
		...
		VertexRDD<Integer> minusVertex = graph.vertices().diff(minusRdd.rdd());
