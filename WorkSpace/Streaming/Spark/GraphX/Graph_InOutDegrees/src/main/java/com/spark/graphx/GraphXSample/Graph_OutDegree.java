...
public class Graph_OutDegree implements Serializable {
	private static final long serialVersionUID = 1L;
	static Logger log = Logger.getLogger(Graph_OutDegree.class);
	...
	public void test() {
		...
		log.info("Out Degrees : " + graph.ops().outDegrees().toJavaRDD().map(e ->

		{
			log.info(" Out Degrees :-- >" + new Tuple2<Object, Object>(e._1, e._2));
			return e;
	...
	public static void main(String[] args) {
		Graph_OutDegree pr = new Graph_OutDegree();
		pr.test();
	}
