...
public class GraphXTriplets {

	Logger log = Logger.getLogger(GraphXTriplets.class);
	...
	public void test() {
		...
		List result = graph.triplets().toJavaRDD()
				.map(e -> e.srcAttr()[0] + " is The " + e.attr + " Of " + e.dstAttr()[0]).collect();
	...
	public static void main(String[] args) {
		GraphXTriplets pr = new GraphXTriplets();
		pr.test();
	}
