...
public class AggregateUsingIndexApp implements Serializable {

	private static final long serialVersionUID = 1L;
	static Logger log = Logger.getLogger(AggregateUsingIndexApp.class);
	...
	public void test() {
		...
		joinList.add(new Tuple2<Object, Integer>(9L, 43));
		...
		VertexRDD<Integer> joinVertex = graph.vertices().aggregateUsingIndex(minusRdd.rdd(), new AggregateFunction(),
	...
	public static void main(String[] args) {
		...
		AggregateUsingIndexApp app = new AggregateUsingIndexApp();
		app.test();
	}
}
