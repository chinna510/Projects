...
public class InnerJoinApp implements Serializable {

	private static final long serialVersionUID = 1L;
	static Logger log = Logger.getLogger(InnerJoinApp.class);
	...
	public void test() {
		...
		VertexRDD<Integer> joinVertex = graph.vertices().innerJoin(minusRdd.rdd(), new InnerJoinFunction(),
	...
	public static void main(String[] args) {
		...
		InnerJoinApp app = new InnerJoinApp();
		app.test();
	}
}
