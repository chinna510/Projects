...
public class UniqueKillSwitchApp implements Serializable {
	...
	private void killswitch() throws InterruptedException, ExecutionException, TimeoutException {
		...
		final Source<Integer, NotUsed> countingSrc = Source.from(new ArrayList<>(Arrays.asList(1, 2, 3,5,4)))
	...
	public static void main(String[] args) throws InterruptedException, ExecutionException, TimeoutException {
		...
		UniqueKillSwitchApp app = new UniqueKillSwitchApp();
		app.killswitch();
	}
