...
public class SAXService {
	...
	public static void parseXMLFile() {
		 ...
		 * SAXService.class.getClassLoader().getResourceAsStream(SAXService.
		 * DATASOURCE_FILE); try { prop.load(input); } catch (IOException e) {
		 * 
		...
		try {
			...
			saxParser.parse(rb.getString("filepath"), handler);
